...
namespace DAO
{
    public class KhachHang_DAO
    {
        ...
        {
            string cmd1 = "delete from CT_HOADON " +
                "where MaHD in " +
                "(select MaHD " +
                "from HOADON " +
                "where MaKhachHang =" + kh.MaKhachHang +") ";
            string cmd2 = " delete from HOADON where MaKhachHang = " + kh.MaKhachHang;
            string cmd3 = " delete from PHIEUTHUTIEN where MaKhachHang =" + kh.MaKhachHang;
            string cmd4 = " delete from BAOCAOCONGNO where MaKhachHang =" + kh.MaKhachHang;

            string sql = "\ndelete from KHACHHANG where MaKhachHang= " + kh.MaKhachHang + "";
            return DataAccess.ThucThiNonQuery(cmd1+" "+cmd2+" "+cmd3+" "+cmd4+" "+sql);           
        }
